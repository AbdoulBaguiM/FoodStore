        ...
        <div class="row tm-content-row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-block-col">
                <div class="tm-bg-primary-dark tm-block tm-block-products">
                    <div class="tm-product-table-container">
                        <table class="table table-hover tm-table-small tm-product-table">
                            ...
                            <c:forEach var="utilisateur" items="${utilisateurs}">
                                <tr>
                                    <th scope="row"><input type="checkbox" value="${utilisateur.id}"/></th>
                                    <td>${utilisateur.id}</td>
                                    <td class="tm-product-name">${utilisateur.name}</td>
                                    <td>${utilisateur.email}</td>
                                    <td>${utilisateur.telephone}</td>
                                    <td>${utilisateur.adresse}</td>
                                    <td>${utilisateur.createdAt}</td>
                                    <td>
                                        <a href="/admin/compte?id=${utilisateur.id}" class="tm-product-delete-link">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        <a href="/admin/compte?id=${utilisateur.id}&del" class="tm-product-delete-link">
                    ...
                    <!-- table container -->
                    <a href="/admin/compte" class="btn btn-primary text-uppercase mb-3">Ajouter un utilisateur</a>
